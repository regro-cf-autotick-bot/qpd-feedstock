...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/qpd-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14068&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/qpd-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `qpd` can be installed with:

```
conda install qpd
```

It is possible to list all of the versions of `qpd` available on your platform with:
